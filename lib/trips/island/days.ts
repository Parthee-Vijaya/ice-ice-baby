...
export const days: DayPlan[] = [
  ...
  },
  {
    ...
    itinerary: [
      {
        transport: "7 km · 8 min",
        sted: "Kolgrafarfjörður viewpoint (Eyrbyggja på kortet)",
        varighed: "15–30 min",
        beskrivelse:
          "Vejen over fjorden ser ud som et sværd, der skærer gennem vandet. Snæfellsnesvegur 351.",
      },
      {
        tid: "Kl. 10.15 (ankomst 10.45)",
        transport: "32 km · 27 min",
        sted: "Færgen Baldur i Stykkishólmur kl. 11.00",
        varighed: "2t 30 min",
        beskrivelse:
          "Sejltur til Vestfjordene med pit-stop på øen Flatey. Vi lander i Brjánslækur. Hold øje med søpapegøjer (særligt ved øen) og hvaler — måske spækhuggere.",
      },
      {
        tid: "Kl. 13.30",
        transport: "2,9 km · 4 min",
        sted: "Fiskabúðin (lille butik på Flatey)",
        beskrivelse: "Sælger fisk, brød og små nips.",
      },
      {
        transport: "3,5 km · 5 min",
        sted: "Hellulaug Hot Spring",
        varighed: "30 min + tøjskifte",
        beskrivelse: "Badestop. Findes på Google Maps (ikke Apple Kort).",
      },
      {
        transport: "25 km · 33 min",
        sted: "Reykjafjarðarlaug hot spring/pool",
        beskrivelse:
          "Både en naturlig varm kilde og et anlagt bassin — afsides og fredeligt, ingen organiserede ture stopper her.",
      },
      {
        transport: "4,7 km · 7 min",
        sted: "The A-house (forladt lade)",
        beskrivelse:
          "Rustik, forladt lade i Arnarfjörður — et billede på Islands landlige fortid og arkitektur.",
      },
      {
        transport: "1,1 km · 2 min",
        sted: "Fossfjörður vandfald (Foss)",
        beskrivelse:
          "Vandfaldet løber ned ad en klippefyldt skråning i flere trin — helt ned til vandkanten.",
      },
      {
        transport: "44 km · 1t",
        sted: "Dynjandi vandfald",
        beskrivelse:
          "Vestfjordenes største vandfald (100 m). Vandr til toppen — 200 m opstigning forbi flere mindre fald. Husk vandreskoene!",
      },
      {
        transport: "77 km · 1t 31 min",
        sted: "Tálknafjörður campsite",
      },
    ],
